...
namespace ReadyGamerOne.Script.Editor
{
    ...
    public class AbstractCharacterControllerEditor:UnityEditor.Editor
    {
        ...
        protected event Action onInspectorGUI_Walk;
        protected event Action onInspectorGUI_Run;
        protected event Action onInspectorGUI_Dash;
